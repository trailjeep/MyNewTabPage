...
chrome.runtime.onInstalled.addListener(function (details) {
    ...
    var sites =
        [
			...
			{ name: 'ESPN', url: 'http://www.espn.com/', imgUrl: 'espn.png', id: 5 },
			{ name: 'Pearce Email', url: 'https://apps.rackspace.com/index.php', imgUrl: 'pearce.png', id: 6 },
			{ name: 'Pearce', url: 'https://www.hpearce.com/', imgUrl: 'pearce.png', id: 7 },
			{ name: 'CTMLS', url: 'https://idp.ctmls.safemls.net/idp/Authn/UserPassword', imgUrl: 'ctmls.png', id: 8 },
			{ name: 'Homesnap', url: 'https://www.homesnap.com/', imgUrl: 'homesnap.png', id: 9 },
			{ name: 'Photos', url: 'https://photos.google.com/', imgUrl: 'photos.png', id: 10 },
			{ name: 'Mahjong', url: 'http://www.247mahjong.com/?chromestore=1', imgUrl: 'mahjong.png', id: 11 }
        ];
    var icons =
        [
